module.exports = {
    ...
    themeConfig: {
        nav: [{'text': '首页', 'link': '/'}, {
            ...
            }, {'text': '抓包', 'link': '/测试开发/抓包/burpsuit工具抓包'}, {
                'text': '故事',
        ...
        sidebar: {
            '/App测试/': [{
                ...
                }, {'title': '设备功能测试', 'path': '/App测试/业务和技术驱动/设备功能测试'}]
            }, {
                'title': '测试类型',
            ...
            '/性能测试/': [{
                ...
                }, {'title': '分离接口逐个压测的优势', 'path': '/性能测试/性能诊断/分离接口逐个压测的优势'}]
            }, {
                'title': '性能调优',
            ...
            '/测试开发/': [{
                ...
                }, {'title': '分布式系统常用组件', 'path': '/测试开发/分布式系统/分布式系统常用组件'}]
            }, {
                'title': '可测试性',
